                    ...
                    <h3 class="m-4 mx-5 px-4 ">les droits d'acces pour l'utilisateur : <span class="text-danger">*</span> </h3>
                        <div class="container mx-5 px-5">
                            <div class="form-check form-switch  my-3">
                                ...
                                <input class="form-check-input mx-3" type="checkbox" value="partager"  name="partager" id="flexSwitchCheckDefault">
                            </div>
                            <div class="form-check form-switch  my-3">
                                <label class="form-check-label" for="flexSwitchCheckDefault">Modifier les projets</label>
                                <input class="form-check-input mx-3" type="checkbox" value="modifier"  name="modifier" id="flexSwitchCheckDefault">
                            </div>
                            <div class="form-check form-switch  my-3"> 
...
<?php
   ...
   if(empty($cni) || empty($prenom) || empty($nom) || empty($post) || empty($_POST['usertype']) || empty($password)){
        ...
        $postdb2= $con->query($postsql2);
            ...
            $sql = "INSERT INTO users (cni, prenom, nom,email,username,password,idtype,idpost,partager,modifier,supprimer) VALUES (?,?,?,?,?,?,?,?,?,?,?)";
            $stmt= $con->prepare($sql);
            $stmt->execute([$cni, $prenom, $nom ,$email, $nom, $password,$idtypes, $idposts,$perpar,$permod,$persup]);

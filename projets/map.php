...
$map = "var $projet = new ol.layer.Tile({   title: '$projet',   visible: $visi,    source: new ol.source.TileWMS({ url: 'http://localhost/geoserver/wilayaSIG/wfs',      params: {'LAYERS':'wilayaSIG:$projet','TILED':true}, serverType: 'geoserver',    })  }); map.addLayer($projet);";

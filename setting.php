        ...
        <div class="container mx-5 px-5">
            <form action="setting.php" method="post">
                ...
                <table class=" table-striped  table  ">
                    <tbody>
                        <tr>
                            ...
                            <td class="h6"><?php echo $res['cni'];?></td>
                        </tr>
                        <tr>
                            <td  class=" text-center"><lable class=" " for="">Prénom :  </label></td>
                            <td class="h6"><?php echo $res['prenom'] ;?></td>
                        </tr>
                        <tr>
                            <td  class=" text-center"><lable class=" " for="nom">Nom :  </label></td>
                            <td class="h6"><?php echo $res['nom'] ;?></td>
                        </tr>
                        <tr>
                            <td  class=" text-center"><lable class="" for="email">Email :</label></td>
                            <td class="h6"><?php echo $res['email'] ;?></td>
                        </tr>
                        <tr>
                            <td  class=" text-center"><lable class=" " for="">Poste de travail :  </label></td>
                            <td class="h6"><?php echo $res['postravail'] ;?></td>
                        </tr>
                        <tr>
                            <td  class=" text-center"><lable class=" " for="password">Nom d'utilisateur </label></td>
                            <td class="h6"><?php echo $res['username'] ;?></td>
                        </tr>
                        <tr>
                            <td  class=" text-center"><lable class=" " for="password">Mot de passe  </label></td>
                            <td class="h6"><?php echo $res['password'] ;?></td>
                        </tr>
                    </table>
                ...
                <div class="text-center">
                    <button class="btn bg-secondary my-3"><a href="modifyprofil.php?cni=<?php echo $codeid; ?>" class="nav-link text-light">Modifier</a></button>
                </div>
            </div>
        </form>
   </div>

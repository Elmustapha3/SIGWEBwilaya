<?php
    ...
    $sql = 'select cni, prenom, nom , partager, modifier, supprimer from users ;';
    $user= $con->query($sql);
    $i=1;
            ...
            <form action="administrerUser.php" method="post">
                ...
                <table class="table table-striped text-center">
                        <thead>
                            ...
                            <th scope="col">droit de modifier</th>
                        ...
                        <tbody>
                            ...
                            <?php foreach($user as $row){
                                ...
                                if($row['modifier']==1){$row['modifier']='Oui'; }else{$row['modifier']='Non';}
                            ...
                            echo '<tr>';
                                ...
                                echo '<td class="p-2 px-3">'.$row['modifier'].'</td>';

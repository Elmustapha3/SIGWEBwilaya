...
var serverPort = 'localhost';
var geoserverWorkspace = 'wilayaSIG';
var projectionName = 'EPSG:26191';
var layerList = [];
...
lyrsButton.innerHTML = '<img src="resources/images/ad.png" alt="" class="myImg"></img>';
...
panButton.innerHTML = '<img src="resources/images/ad.png" alt="" class="myImg"></img>';
...
map.on('singleclick', function (evt) {
    if (featureInfoFlag) {
        ...
        var url = IndiaDsTile.getSource().getFeatureInfoUrl(evt.coordinate, resolution, 'EPSG:26191', {
...
var printControl = new ol.control.Control({
    ...
    printButton.addEventListener("click", () => {
        printButton.classList.toggle('clicked');
        printFlag =!printFlag;
        document.getElementById("map").style.cursor= "default";
    windows.print();
...
bufferButton.innerHTML = '<img src="resources/images/ad.png" alt="" class="myImg"></img>';
...
//  add all editing control to map

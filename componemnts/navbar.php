...
<body>
            ...
            <nav class="navbar navbar-expand-lg bg-dark text-dark navbar-dark ">
              ...
              <!--  -->
              <a class="nav-link active text-light px-5 " aria-current="page" href="index.php">Accueil</a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                  <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                      <a class="nav-link my-2px-3 active" href="mylayers.php">Votre espace</a>
                    </li>
                    <?php }?>
                  </ul>
                  <?php
                  ...
                  <div class="btn-group">
                      <form action="navbar.php" method="post">
                          ...
                          <ul class="dropdown-menu dropdown-menu-lg-end  ">
                            ...
                            <li><a  href="componemnts/log.php" class="dropdown-item"  >logout</a></li>
                          </ul>
                      </form>
                  </div>
              <?php } ?>                    

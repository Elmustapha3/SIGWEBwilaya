                ...
                <form action="updatemetadonnes.php" method="post">
                    ...
                    <div class="mx-5 px-5">
                        ...
                        <div class="form-outline mb-4">
                            ...
                            <textarea class="form-control" id="form4Example3" name="desc" rows="4"><?php echo $res['description'] ?></textarea>
                        </div>
                        <?php if($res['layerpartager']==1){ $checkp='checked';}else{ $checkp='';}  ?>
                        ...
                        <div class="text-center">
                            ...
                            <a href="layer.php?idlayer=<?php echo $idlayer; ?>" class="btn bg-primary text-light">Anuuler</a>
                            <button class="btn bg-primary text-light" name="modl">Modifier</button>
                        </div>
                        <?php } ?>
                    </div>
                </form>
